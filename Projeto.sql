...
--Catarina Sindorf
--Jefferson Charles Bassoto
--Marcos Felippe de Araújo
--Valeria Naomi kikusaki
--Yasmin Dias de Carvalho
...
create table vendas.cliente(
	...
	idUsuario integer REFERENCES vendas.usuario (idusuario),
	email varchar(160),
	cpf varchar(11),
	dataNascimento date,
...
(nomeCompleto, idUsuario, email, cpf, dataNascimento, idendereco)
values
('Maria da Silva', 1, 'maria@gmail.com', '23365487999', '04-03-1989', 1),
('João Fonseca', 2, 'joao@gmail.com', '98854785122', '25-10-1988', 2),
('Paulo Andrade', 3, 'paulo@gmail.com', '65432965498', '29-01-1961', 3),
('Ana Antunes', 4, 'ana@gmail.com', '91532647896', '03-02-1975', 4),
('José Oliveira', 5, 'jose@gmail.com', '39654896320', '02-07-1992', 5);
...
(serie, emissao)
values
('1A1B', '26-08-2022 15:02:00'),
('2A2B', '14-08-2022 08:30:00'),
('3A3B', '04-07-2022 12:16:00'),
('4A4B', '02-07-2022 16:45:00'),
('5A5B', '12-06-2022 19:06:00');

insert into vendas.PedidoItem
(idcliente, idnota, idProduto, quantidade, valorUnitario)
values
(1, 1, 1, 1, 250.90),
(2, 1, 2, 2, 100),
(3, 2, 5, 2, 50),
...
left join vendas.cliente c on c.idcliente = i.idcliente
